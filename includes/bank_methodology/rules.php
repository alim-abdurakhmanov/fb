 ...
 * FinScore сюда не входит — это отдельный контур.
 */
...
function bank_methodology_rules(): array
{
    ...
    $rules = [
        ...
        'stop_factors' => [
            ...
            ['code' => '1.3', 'group' => 'status', 'label' => 'Ликвидация / банкротство Принципала', 'mandatory' => true],
            ['code' => '1.4', 'group' => 'status', 'label' => 'Реорганизация в форме присоединения', 'mandatory' => true],
            ['code' => '1.5', 'group' => 'status', 'label' => 'Срок деятельности менее 6 месяцев', 'mandatory' => true],
            ['code' => '2.1', 'group' => 'owners', 'label' => 'В УК — недействующие / ликвидированные ЮЛ', 'mandatory' => true],
            ['code' => '2.2', 'group' => 'owners', 'label' => 'В УК — ЮЛ с решением об исключении из ЕГРЮЛ', 'mandatory' => true],
            ['code' => '2.3', 'group' => 'owners', 'label' => 'В УК — ЮЛ в банкротстве', 'mandatory' => true],
            ['code' => '2.4', 'group' => 'owners', 'label' => 'В УК — ЮЛ с намерением банкротства', 'mandatory' => true],
            ['code' => '2.5', 'group' => 'owners', 'label' => 'В УК — ЮЛ с реорганизацией (присоединение)', 'mandatory' => true],
            ['code' => '3', 'group' => 'registry', 'label' => 'В реестре дисквалифицированных лиц', 'mandatory' => true],
            ['code' => '4', 'group' => 'registry', 'label' => 'В реестре недобросовестных поставщиков (РНП)', 'mandatory' => true],
            ['code' => '5.1', 'group' => 'region', 'label' => 'Бенефициар <50% (не ЕИО) в регионе повышенного риска (короткий перечень)', 'mandatory' => true],
            ['code' => '5.2', 'group' => 'region', 'label' => 'Бенефициар ≥50% или ЕИО в регионе повышенного риска (расширенный перечень)', 'mandatory' => true],
            ['code' => '5.3', 'group' => 'region', 'label' => 'Клиент / предмет тендера в регионе риска или за рубежом', 'mandatory' => true],
            ['code' => '6', 'group' => 'persons', 'label' => 'Судебный запрет на участие/руководство для ЕИО', 'mandatory' => true],
            ['code' => '7', 'group' => 'persons', 'label' => 'Экстремизм / терроризм (руководитель, учредитель или компания)', 'mandatory' => true],
            ['code' => '8', 'group' => 'persons', 'label' => 'Недействительные паспорта руководителя / учредителей', 'mandatory' => true],
            ['code' => '9', 'group' => 'legal', 'label' => 'Арбитраж + ФССП > 35% годовой выручки', 'mandatory' => true],
            ['code' => '10', 'group' => 'beneficiary', 'label' => 'Бенефициар не из допустимых категорий (для 223-ФЗ)', 'mandatory' => true],
            ['code' => '11', 'group' => 'aml', 'label' => 'Чёрная зона ОФМ / расторжение 115-ФЗ', 'mandatory' => true],
            ['code' => '12', 'group' => 'aml', 'label' => 'ЗСК ЦБ — красная зона', 'mandatory' => true],
            ['code' => '13', 'group' => 'aml', 'label' => 'Коды 764-П: 07/08 (>5) или 09 (1) за 12 мес.', 'mandatory' => true],
            ['code' => '14', 'group' => 'security', 'label' => 'Отрицательное заключение СБ по прошлым заявкам', 'mandatory' => true],
            ['code' => '15', 'group' => 'deal', 'label' => 'Аффилированность принципал–бенефициар (615-П / коммерция)', 'mandatory' => true],
